<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrarUsuario.aspx.cs" Inherits="MegaplexStarsStore.RegistrarUsuario" %>
...
<body>
    ...
    <div class="auto-style1">
        ...
        <table align="center" class="auto-style8">
            <tr>
                <td colspan="1" class="auto-style10"><strong style="font-family: Arial, Helvetica, sans-serif; font-style: italic; text-decoration: underline overline; font-size: 15px; color: #000000">REGISTRAR USUARIO</strong></td>
            </tr>
            <tr>
